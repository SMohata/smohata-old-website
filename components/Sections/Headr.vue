<template>
  <header>
    ...
    >
      <main v-if="about">
        <p class="mb-1 font-sourcecode text-blue-500 dark:text-cyan-400">
          Hi, my name is
        </p>
        <h1 class="text-5xl md:text-7xl lg:text-7xl font-bold">
          {{ about.name }}
        </h1>
        <h2
          class="text-6xl md:text-6xl lg:text-7xl font-bold text-gray-500 dark:text-gray-400"
        >
          {{ about.title }}
        </h2>
