    ...
    <div class="container mx-auto px-8 py-4 md:px-20 md:py-10 max-w-6xl">
      ...
      <div v-if="about" class="lg:grid lg:grid-cols-2">
        ...
        <div class="mt-6 lg:mt-0">
          ...
          >
            <div
              class="border-solid border-4 border-light-blue-500 absolute inset-0 bg-blue-500 dark:bg-cyan-400 bg-opacity-50 dark:bg-opacity-50 transition duration-300 hover:bg-opacity-0 dark:hover:bg-opacity-0"
            ></div>
            <img
