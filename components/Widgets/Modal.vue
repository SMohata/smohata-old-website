<template>
  ...
  >
    ...
    >
      <div
        class="px-2 py-1 bg-blur bg-white bg-opacity-90 dark:bg-gray-800 dark:bg-opacity-90 sticky top-0 w-full flex items-center justify-between z-10"
      ></div>
      <div class="px-8 py-4 md:pb-8 md:grid md:gap-8 md:grid-cols-2">
        <div class="md:mb-0 h-40 md:h-60 rounded-xl overflow-hidden">
          <img
